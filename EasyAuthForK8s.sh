...
CLIENT_ID=$(az ad app create --display-name $AD_APP_NAME --homepage $HOMEPAGE --reply-urls $REPLY_URLS -o json | jq -r '.appId')
...
echo "UPDATE @ $(date +"%T"): Sleeping 30 seconds before creating cluster-issuer-prod..."
sleep 30
